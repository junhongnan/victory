...
public class AuthPageController {
    ...
    @RequestMapping("/SAFELogin.html")
    public ModelAndView homepage(HttpServletRequest httpRequest) throws ParseException{
    ...
    public void signOut(HttpServletRequest httpRequest, HttpServletResponse response) throws IOException {
        ...
        String redirectUrl = "https://localhost:8082/cqm-DEV";
